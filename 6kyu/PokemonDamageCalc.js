...
function effectiveness (yourType, oppoType) {

    if(yourType === "fire" && oppoType === "grass" 
    || yourType === "water" && oppoType === "fire" 
    || yourType === "grass" && oppoType === "water"
    || yourType === "electric" && oppoType === "water") {
        return 2.0;
    } else if (yourType === oppoType 
        || yourType === "fire" && oppoType === "water" 
        || yourType === "water" && oppoType === "grass" 
        || yourType === "grass" && oppoType === "fire" 
        || yourType === "water" && oppoType === "electric"){
        return 0.5;
    } else if (yourType === "fire" && oppoType === "electric" 
        || yourType === "electric" && oppoType === "fire" 
        || yourType === "electric" && oppoType === "grass" 
        || yourType === "grass" && oppoType === "electric" ) {
      return 1;
    } 
}
...
let effect = effectiveness(yourType, opponentType);
console.log(effect);
